package com.walmartlabs.ern.electroidscreenminiapp;

import com.walmartlabs.ern.container.miniapps.ElectroidscreenMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = ElectroidscreenMiniappActivity.class;
